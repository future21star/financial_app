...
export class BankDetailPage {
  ...
  ionViewDidLoad() {
    ...
    this.dataService.getTransactionHistory(this.bank._id).subscribe(
      data => {
        this.transaction_history = data.body["OFX"]["BANKMSGSRSV1"]["STMTTRNRS"]["STMTRS"]["BANKTRANLIST"]["STMTTRN"];
    });
  }
